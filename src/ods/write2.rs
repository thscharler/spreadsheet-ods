...
use crate::ods::xml_util::XmlWriter;
...
/// Writes the ODS file.
pub fn write2_ods<P: AsRef<Path>>(book: &WorkBook, ods_path: P) -> Result<(), OdsError> {
    write2_ods_clean(book, ods_path, true, true)?;
    Ok(())
}

/// Writes the ODS file. The parameter clean indicates the cleanup of the
/// temp files at the end.
pub fn write2_ods_clean<P: AsRef<Path>>(book: &WorkBook,
                                        ods_path: P,
                                        zip: bool,
